...
public class HealthManagerEditor : Editor
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        hmTarget.invulnerable = EditorGUILayout.Toggle("Invulnerable", hmTarget.invulnerable);
        hmTarget.hurtSound = EditorGUILayout.ObjectField("Hurt Sound", hmTarget.hurtSound, typeof(AudioClip), !EditorUtility.IsPersistent(target)) as AudioClip;
